<div class="container-xl">
    ...
    <div class="section-intro">Masukkan data kategori dengan baik, jika ada kendala dapat hubungi admin, <a href="#">help.</a></div>
    <hr class="mb-4">
                ...
                <div class="app-card-body">
                    <form method="POST" action="index.php?page=kategori_proses" class="settings-form">
                        <div class="mb-3">
                            ...
                            <input type="text" name="cat_name" class="form-control" id="setting-input-1" required>
                        </div>
                        <div class="mb-3">
                            <label for="setting-input-2" class="form-label">Keterangan</label>
                            <input type="text" name="cat_ket" class="form-control" id="setting-input-2" required>
                        </div>
